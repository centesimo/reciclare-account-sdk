...
class AccountApiClientUser
{
    ...
    {
        return AccountApiConfig::apiUrl().'/user/change_password';
    }
    ...
    public static function changePassword($user_login, $data)
    {
        try {
            $client = new Client();
            $res = $client->request('POST', AccountApiClientUser::serverApiUrlUserChangePassword(). '/' .$user_login, [
                'form_params' =>
                    [
            ...
            throw new AccountApiClientException('Erro trocando senha.', $error_messages);
        }
    }
